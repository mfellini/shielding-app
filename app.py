...
PRESHIELDING_XPRE = {
    "PIOMBO": 0.85, # mm [cite: 3]
    "CEMENTO": 72.0, # mm (7.2 cm) [cite: 3]
    "ACCIAIO": 7.0 # mm [cite: 3]
}
# ====================================================================
...
def calculate_primary_thickness(params):
    ...
    Xpre = PRESHIELDING_XPRE.get(materiale, 0.0)
...
def run_shielding_calculation(params):
    ...
    # -------------------------------------------------------------------------
    # RAMO 2: DIAGNOSTICA SPECIALIZZATA (Mammo, Angio, Fluoroscopia)
    # -------------------------------------------------------------------------
    elif tipo_immagine == "RADIOLOGIA DIAGNOSTICA" and \
         modalita_radiografia in ["MAMMOGRAFIA", "ANGIO CARDIACA", "ANGIO PERIFERICA", "ANGIO NEURO", "FLUOROSCOPIA"]:
